...
def main():
    ...
    pattern = r'((?:github-readme-stats\.shion\.dev|streak-stats\.demolab\.com|streak-stats\.vercel\.app|github-readme-activity-graph\.vercel\.app|komarev\.com)[^"\']*?cache_bust=)\d+'
